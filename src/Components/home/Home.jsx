        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-24">
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="relative group">
              <button
                className="relative bg-white text-black font-serif text-xl px-10 py-10 rounded-full w-40 h-40 sm:w-48 sm:h-48 md:w-56 md:h-56 flex items-center justify-center uppercase tracking-widest transition-all duration-300 hover:shadow-[0_0_0_45px_rgba(255,255,255,0.3)] lg:hover:shadow-[0_0_0_75px_rgba(255,255,255,0.3)]"
              >
                Explore
              </button>
            </div>
